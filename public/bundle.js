	...
	var Main = React.createClass({
	  render: function () {
	    return React.createElement(
	      'div',
	      { classNmae: 'main-container' },
	      React.createElement(
	        'nav',
	        { className: 'navbar navbar-default', role: 'navigation' },
	        React.createElement(
	          'div',
	          { className: 'col-sm-7 col-sm-offset-2', style: { marginTop: "15px" } },
	...
	var Profile = React.createClass({
		...
		render: function () {
			...
			return React.createElement(
				...
				React.createElement(Notes, { notes: this.state.notes, username: this.props.params.username, addNote: this.handleAddNote })
			);
		}
	...
	var UserProfile = React.createClass({
		...
		render: function () {
			...
			var fields = fieldNames.map(function (field, index) {
				return bio[field] == 0 ? null : bio[field] && React.createElement(
					'li',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddNotes = __webpack_require__(214);
	...
	var Notes = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(AddNotes, { addNote: this.props.addNote }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function xhrAdapter(resolve, reject, config) {
	  ...
	  if (utils.isStandardBrowserEnv()) {
	    ...
	    var urlIsSameOrigin = __webpack_require__(226);
